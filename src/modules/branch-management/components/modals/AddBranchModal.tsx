...
export function AddBranchModal({ onClose, onSave }: AddBranchModalProps) {
 ...
 validationErrors.name ? 'border-red-500/40 bg-red-500/10' : 'border-border bg-surface-2'
 ...
 className={`w-full rounded-xl border ${
 validationErrors.phone ? 'border-red-500/40 bg-red-500/10' : 'border-border bg-surface-2'
 ...
 rows={2}
 className={`w-full rounded-xl border ${
 validationErrors.address ? 'border-red-500/40 bg-red-500/10' : 'border-border bg-surface-2'
 ...
 className={`w-full rounded-xl border ${
 validationErrors.openTime ? 'border-red-500/40 bg-red-500/10' : 'border-border bg-surface-2'
 ...
 className={`w-full rounded-xl border ${
 validationErrors.closeTime ? 'border-red-500/40 bg-red-500/10' : 'border-border bg-surface-2'
 } pl-11 pr-4 py-3 text-sm text-foreground outline-none transition-colors hover:border-primary focus:border-primary focus:bg-surface-1 focus:ring-2 focus:ring-primary/20`}
 />
 </div>
 ...
 className={`w-full rounded-xl border ${
 validationErrors.managerId ? 'border-red-500/40 bg-red-500/10' : 'border-border bg-surface-2'
