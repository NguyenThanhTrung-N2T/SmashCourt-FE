...
export default function Header({
    ...
    return (
        <header className="h-[72px] flex items-center justify-between px-2 shrink-0">
            ...
            {/* Right: icons + theme toggle + profile */}
            <div className="flex items-center gap-3">
                <button
                    aria-label="Tin nhắn"
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-surface-1 text-muted hover:text-foreground shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1B5E38]"
                >
