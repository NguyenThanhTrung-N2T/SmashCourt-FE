...
export default function PublicSiteFooter() {
 ...
 <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/10 text-[#2A9D5C]">
 ...
 <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-[#2A9D5C]/80">
 ...
 <Link
 href="/auth/register"
 className="inline-flex items-center gap-2 rounded-full bg-[#2A9D5C] px-5 py-2.5 text-sm font-extrabold text-white transition-all hover:-translate-y-0.5 hover:bg-[#1B5E38]"
 >
 Tạo tài khoản
