...
import { CUSTOMER_NAV } from "../navigation/customer.navigation";
...
const menuItems = CUSTOMER_NAV.filter((item) => item.href !== "/settings");
const sysItems = CUSTOMER_NAV.filter((item) => item.href === "/settings");
...
export default function CustomerSidebar({
  ...
  function isActive(item: NavItem) {
    ...
    // For /bookings, only match exactly /bookings or /bookings/[id]
    // Don't match /bookings/new
