...
import { STAFF_NAV } from "../navigation/staff.navigation";
...
const menuItems = STAFF_NAV.filter((item) => item.href !== "/staff/settings");
const sysItems = STAFF_NAV.filter((item) => item.href === "/staff/settings");
