...
import { Input, Select } from "@/src/shared/components/ui";
import { MagnifyingGlass, FunnelSimple, SortAscending } from "@phosphor-icons/react";
import type { StaffUserStatus, StaffUserRole } from "@/src/features/staff/shared/types/user.type";
...
interface StaffFiltersProps {
  ...
  roleFilter?: StaffUserRole | "";
  onRoleChange?: (value: StaffUserRole | "") => void;
}
...
export function StaffFilters({
  ...
  const showRoleFilter = roleFilter !== undefined && onRoleChange !== undefined;
  ...
  return (
    <div className="rounded-2xl border border-border bg-surface-1 p-4">
      <div className="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
        ...
        {/* Right: Role, Status Filter and Sort */}
        <div className="flex flex-col sm:flex-row gap-3 lg:flex-shrink-0">
          ...
          {showRoleFilter && (
            <div className="flex items-center gap-2">
              <Select
                value={roleFilter}
                onChange={(value) => onRoleChange(value as StaffUserRole | "")}
                placeholder="Vai trò"
              >
