...
import { MagnifyingGlass, FunnelSimple, SortAscending, UserCircle } from "@phosphor-icons/react";
import type { StaffUserStatus, StaffUserRole } from "@/src/features/staff/types/user.type";

interface OwnerStaffFiltersProps {
  searchTerm: string;
