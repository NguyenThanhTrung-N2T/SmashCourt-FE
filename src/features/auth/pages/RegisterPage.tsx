    ...
    >
      ...
      <form className="flex flex-col gap-6" onSubmit={onSubmit}>
        ...
        <p className="mt-8 text-center text-base font-medium text-slate-600">
          ...
          <Link
            href="/auth/login"
            className="inline-flex min-h-12 items-center justify-center rounded-xl px-4 text-lg font-extrabold text-emerald-600 transition-colors hover:bg-emerald-50 hover:text-emerald-505 hover:underline"
          >
            Đăng nhập hệ thống
          </Link>
        </p>
