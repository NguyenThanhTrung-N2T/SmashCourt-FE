...
import type { CourtType, TabId } from "../../../shared/types/pricing.types";
                ...
                {(
                    ...
                    return (
                        <button
                            ...
                            className={`relative inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-bold transition-all duration-200 ${active
                                ? "bg-surface-1 text-primary shadow-md"
                                : "text-muted hover:text-foreground hover:bg-surface-1/50"
                                }`}
                        >
                            <div
                                className={`flex h-6 w-6 items-center justify-center rounded-lg transition-all ${active ? "bg-primary shadow-sm" : "bg-surface-3"
                                    }`}
                            >
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    {courtTypes.map((ct) => (
                        <button
                            ...
                            className={`relative flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-bold transition-all ${selectedCourtType === ct.id
